...
int main(int argc, char** argv) {
      ...
      ofstream input1(".\\data\\smallmartix\\martix1.txt"), input2(".\\data\\smallmartix\\matrix2.txt");
      ofstream output("C:\\Users\\chena\\Desktop\\Martix  Muitply\\data\\smallmartix\\output.txt");
